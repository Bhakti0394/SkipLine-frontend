...
export default function Settings() {
  ...
  const menuItems = [
    { label: 'Payment Methods', icon: CreditCard, badge: '2 cards', color: '#ff6b35' },
    { label: 'Security', icon: Shield, badge: null, color: '#f7931e' },
    { label: 'Language', icon: Globe, badge: 'English', color: '#fbbf24' },
    { label: 'Connected Devices', icon: Smartphone, badge: '3 devices', color: '#ff6b35' },
  ];
      ...
      <div className="settings">
        ...
        <div className="settings__hero">
          <div className="settings__hero-gradient">
            <motion.div
              className="settings__hero-gradient-orb settings__hero-gradient-orb--1"
              animate={{ scale: [1, 1.2, 1], rotate: [0, 90, 0] }}
              transition={{ duration: 20, repeat: Infinity }}
            />
            <motion.div
              className="settings__hero-gradient-orb settings__hero-gradient-orb--2"
          ...
          >
            <motion.div
              ...
              className="settings__title-badge"
            >
              <SettingsIcon className="settings__title-badge-icon" />
              <span>Customize</span>
            </motion.div>
        ...
        <div className="settings__grid">
          ...
          >
            ...
            <div className="settings__card-header">
              <div className="settings__icon-wrapper settings__icon-wrapper--primary">
                <Bell className="settings__icon" />
              </div>
                ...
                >
                  <div className="settings__item-content">
                    <div className="settings__item-icon-wrapper">
                      <setting.icon className="settings__item-icon" />
                    </div>
                    <div className="settings__item-text">
                      <p className="settings__item-label">{setting.label}</p>
                      <p className="settings__item-desc">{setting.description}</p>
                    </div>
                  </div>
                  <Switch 
                    checked={setting.enabled} 
                    onCheckedChange={() => handleToggle(setting.key, true)}
                  />
                </motion.div>
              ))}
            </div>
            ...
            <div className="settings__info">
              ...
              <div className="settings__info-text">
                <strong>Smart Notifications:</strong> Get critical updates even when notifications are off
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="settings__card settings__card--full"
          >
            <div className="settings__card-glow" />
            
            <div className="settings__card-header">
              <div className="settings__icon-wrapper settings__icon-wrapper--user">
                <User className="settings__icon" />
              </div>
              ...
              {menuItems.map((item, index) => (
                ...
                >
                  ...
                  <div className="settings__account-right">
                    {item.badge && (
                      <span className="settings__account-badge">{item.badge}</span>
                    )}
          ...
          >
            ...
            <div className="settings__card-header">
              <div className="settings__icon-wrapper settings__icon-wrapper--danger">
                <Shield className="settings__icon" />
              </div>
            ...
            <div className="settings__danger">
              ...
              <Button className="settings__danger-btn">
